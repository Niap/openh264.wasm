...
var ASM_CONSTS = {
  37036: function($0, $1, $2, $3, $4, $5, $6) {frame_callback($0, $1, $2, $3, $4, $5, $6);}
};
function initPthreadsJS(tb){ PThread.initRuntime(tb); }
  ...
  function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(3, 1, fd, offset_low, offset_high, whence, newOffset);
...
/** @type {function(...*):?} */
var _open_decoder = Module["_open_decoder"] = createExportWrapper("open_decoder");

/** @type {function(...*):?} */
var _close_decoder = Module["_close_decoder"] = createExportWrapper("close_decoder");

/** @type {function(...*):?} */
var _decode_nal = Module["_decode_nal"] = createExportWrapper("decode_nal");

/** @type {function(...*):?} */
var _decode_h264buffer = Module["_decode_h264buffer"] = createExportWrapper("decode_h264buffer");
...
var __emscripten_allow_main_runtime_queued_calls = Module['__emscripten_allow_main_runtime_queued_calls'] = 36728;
var __emscripten_main_thread_futex = Module['__emscripten_main_thread_futex'] = 37388;
